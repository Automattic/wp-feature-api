...
Currently, the Features API is implemented as a WordPress plugin.
...
function my_plugin_use_feature() {
    $site_title_feature = wp_find_feature( 'resource-myplugin/site-title' ); // Note: type prefix is added automatically
